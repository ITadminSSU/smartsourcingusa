        ...
        {submitted ? (
          <div className="space-y-4">
            <div className="rounded-lg bg-green-50 border border-green-200 text-green-800 text-sm px-4 py-3">
              If an account matches that email, a password reset link has been sent. Check your
              inbox (and spam folder).
            </div>
            <Link
              href="/admin/login"
              className="block text-center text-sm font-semibold text-[#2c84c4] hover:text-[#2371a8]"
            >
              Back to sign in
            </Link>
          </div>
